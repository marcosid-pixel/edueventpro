...
import { Mail, GraduationCap, ArrowRight, User as UserIcon, Lock, Moon, Sun, Monitor, Cpu, LogIn } from 'lucide-react';
    ...
    <div className="fixed inset-0 flex flex-col lg:flex-row bg-arctic-surface dark:bg-[#030b1a] z-[100] transition-colors duration-500 overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 bg-[#0a111f] flex-col justify-between border-r border-white/5 overflow-hidden">
        ...
        <div className="flex flex-col gap-5 px-12 pt-10 relative z-10">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-blue-500/20 backdrop-blur-md px-4 py-2 rounded-full border border-blue-500/30 w-fit">
            <div className="w-2 h-2 bg-blue-400 rounded-full animate-pulse shadow-[0_0_8px_#60a5fa]" />
            <span className="text-[10px] font-mono text-blue-200 font-bold tracking-[0.2em] uppercase">
              SISTEMA.PRONTO
            </span>
          </div>
      ...
      <div className="flex-1 relative bg-surface dark:bg-[#030b1a] p-8 lg:p-20 flex flex-col justify-center transition-colors duration-500 overflow-y-auto">
        ...
        <motion.div
          ...
          className="w-full max-w-lg mx-auto space-y-10 relative z-10 py-12"
        >
          {/* Cabeçalho */}
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-text-secondary font-medium">
                Crie seu nó de identidade institucional.
              </p>
            </div>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSignup}>
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  <UserIcon className="absolute left-6 top-1/2 -translate-y-1/2 text-text-secondary/30 group-focus-within:text-indigo-core transition-colors" size={18} />
                  <input
                    required
                    value={formData.displayName}
                    onChange={(e) => setFormData({ ...formData, displayName: e.target.value })}
                    className="w-full h-14 bg-transparent border border-outline-variant/60 dark:border-white/10 rounded-xl pl-16 pr-6 text-text-primary dark:text-white placeholder-text-secondary/20 focus:ring-1 focus:ring-indigo-core focus:border-indigo-core transition-all font-medium text-base outline-none"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full h-14 bg-transparent border border-outline-variant/60 dark:border-white/10 rounded-xl px-6 text-text-primary dark:text-white placeholder-text-secondary/20 focus:ring-1 focus:ring-indigo-core focus:border-indigo-core transition-all font-medium text-base outline-none"
                    placeholder="••••••••"
                  />
                </div>
                <div className="relative group">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-16 bg-indigo-core hover:bg-indigo-core/90 text-white rounded-xl font-mono font-black shadow-[0_20px_40px_-10px_rgba(33,112,228,0.3)] transition-all text-lg active:scale-[0.98] group relative overflow-hidden uppercase tracking-[0.2em] mt-4"
            >
              <div className="relative z-10 flex items-center justify-center gap-3">
                {loading ? 'Criando Nó de Identidade...' : (
                  <>
                    Criar Conta
          ...
          <div className="pt-8 border-t border-outline-variant/30 space-y-6">
            ...
            <div className="flex justify-between items-center text-text-secondary/40">
              <div className="flex items-center gap-2">
                <Monitor size={14} />
                <p className="text-[9px] font-mono tracking-[0.2em] uppercase font-bold">NODE.AUTH v5.2.0</p>
              </div>
